...
AsynchFileWriter::AsynchFileWriter() //(t_object * maxObject) //: Timer(maxObject)
{
	//maxObject_=maxObject;
	//m_clock = clock_new((t_object *)maxObject, (method)timerCallback2); //create the clock
...
{
//}
//void AsynchFileWriter::timerCallback2(t_object *polhemusSoundRec)
//{
