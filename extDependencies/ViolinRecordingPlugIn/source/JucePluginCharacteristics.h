...
*/
#define JucePlugin_Name                     "Violin Recording Plug-In"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "Tool to help perform synchronized motion tracking and audio recordings"

/** The name of your company. (Try to keep this as short as possible)
*/
#define JucePlugin_Manufacturer             "IUA-MTG"

/** A four-character code for your company.
    Use single quotes - this isn't a string!
*/
#define JucePlugin_ManufacturerCode         'MTG_'
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'VlnR'
...
/** The maximum number of channels of audio output that the plugin can handle.
    ...
    method.
*/
#define JucePlugin_MaxNumOutputChannels             3
...
#define JucePlugin_PreferredChannelConfigurations   { 3, 3 }
...
#define JucePlugin_VersionCode              0x00010000
...
*/
#define JucePlugin_CFBundleIdentifier       "com.iua-mtg.ViolinRecordingPlugin"
